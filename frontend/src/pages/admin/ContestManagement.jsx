...
const ContestManagement = () => {
  ...
  const mockContests = [
    {
      ...
      description:
        "Solve algorithmic challenges focusing on dynamic programming and graph theory.",
      status: "active",
      type: "weekly",
      startDate: "2025-06-10T14:00:00Z",
      endDate: "2025-06-17T14:00:00Z",
      participants: 234,
      problemCount: 8,
      visibility: "public",
      createdBy: "sofikul sk",
  ...
  const handleSelectAll = () => {
    if (selectedContests.size === currentContests.length) {
      ...
      setSelectedContests(
        new Set(currentContests.map((contest) => contest.id))
      );
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              <div className="text-sm text-gray-300">
                Showing {currentContests.length} of {filteredContests.length}{" "}
                contests
              </div>
          ...
          {showBulkActions && (
            ...
            >
              <div className="flex items-center justify-between">
                <div className="text-sm text-gray-300">
                  {selectedContests.size} contest
                  {selectedContests.size !== 1 ? "s" : ""} selected
                </div>
              ...
              >
                ...
                <div className="space-y-2 text-sm text-gray-400 mb-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <span>
                      {getTimeStatus(contest.startDate, contest.endDate)}
                    </span>
                  </div>
                  <div className="flex items-center">
                  ...
                  <tr>
                    ...
                    >
                      <input
                        ...
                        checked={
                          selectedContests.size === currentContests.length &&
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div>
                          ...
                          <div className="text-xs text-gray-400">
                            {contest.type} • {contest.problemCount} problems
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
