    ...
    try {
      ...
      if (selectedProblem) {
        setProblems((prevProblems) =>
          prevProblems.map((p) =>
            p.id === selectedProblem.id ? { ...p, ...problemDataWithMeta } : p
          )
        );
      } else {
              ...
              {selectedProblem ? (
                  ...
                  <div className="flex justify-between items-start mb-6">
                    <div>
                      ...
                      <div className="flex space-x-3">
                        <span
                          className={`px-3 py-1 text-sm font-medium rounded-lg border ${getDifficultyColor(
                        ...
                        >
                          {selectedProblem.status.charAt(0).toUpperCase() +
                            selectedProblem.status.slice(1)}
                        </span>
                      </div>
                    </div>
                    <motion.button
                ...
                >
                  ...
                  <p className="text-white/60 mb-6">
                    Choose a problem from the list to view its details, or
                    create a new one.
                  </p>
                  <motion.button
                    onClick={handleCreateProblem}
